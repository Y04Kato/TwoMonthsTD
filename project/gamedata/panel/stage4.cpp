...
void Stage4::LoadMap() {
	FILE* fp = nullptr;
	char fname[] = "project/gamedata/resources/csv/Map4Panel.csv";
	errno_t err;
...
void Stage4::LoadDirection() {
	...
	FILE* fp = nullptr;
	char fname[] = "project/gamedata/resources/csv/Map4Direction.csv";
	errno_t err;
	err = fopen_s(&fp, fname, "r");
	for (int i = 0; i < kMapHeight; i++) {
		for (int j = 0; j < kMapWidth; j++) {
...
void Stage4::LoadEvent() {
	FILE* fp = nullptr;
	char fname[] = "project/gamedata/resources/csv/Map4Event.csv";
	errno_t err;
	err = fopen_s(&fp, fname, "r");
	for (int i = 0; i < kMapHeight; i++) {
		for (int j = 0; j < kMapWidth; j++) {
